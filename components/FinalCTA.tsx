...
const FinalCTA = () => {
    return (
        <section className="w-full py-32 bg-white flex flex-col items-center text-center">
            <div className="max-w-4xl mx-auto px-4 flex flex-col items-center gap-12">
                <div className="flex flex-col gap-6">
                    ...
                    <p className="font-sans text-black/50 text-xl max-w-2xl mx-auto leading-relaxed">
                        Get a free AI SEO audit today and stop leaving your visibility to chance.
                    </p>
                </div>

                <div className="flex flex-col items-center gap-6">
                    <CTAButton className="scale-125">
