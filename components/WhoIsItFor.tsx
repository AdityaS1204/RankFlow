        ...
        <section className="w-full py-24 bg-black/[0.01]">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Left: Good fit */}
                    <div className="bg-white p-10 md:p-14 border border-black/5 rounded-[40px] shadow-sm flex flex-col gap-8">
                    ...
                    {/* Right: Not for */}
                    <div className="bg-white p-10 md:p-14 border border-black/[0.05] rounded-[40px] flex flex-col gap-8 opacity-90 grayscale">
